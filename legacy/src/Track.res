...
let demoTrack = {
  ...
  let track =
    list{
      ...
      make(~times=8, ~incline=-6., ~roadSurface=Dirt, ~groundSurface=Water, ~objects=list{}, Straight),
      make(~times=8, ~incline=-5., ~roadSurface=Tarmac, ~groundSurface=Soil, ~objects=list{}, Straight),
