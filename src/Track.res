...
let demoTrack = {
  ...
  let track2 =
    list{
      ...
      make(~times=2, ~incline=8.8, Straight),
      makeCheckpoint(~incline=9.2, ~groundSurface=Gravel, 16),
      ...
      make(~times=1, ~objects=list{makeStone(0.7), makeStone(-0.25)}, Left(mc1)),
      make(~times=8, ~incline=1., Straight),
      makeCheckpoint(~incline=1.2, ~groundSurface=Gravel, 19),
      make(~times=16, ~incline=-0.3, Right(mc2)),
      make(~times=1, ~objects=list{makeStone(-1.1)}, Right(mc1)),
      make(~times=1, ~objects=list{makeStone(0.)}, Right(mc1)),
      make(~times=8, Right(mc2)),
      makeCheckpoint(~incline=1.2, ~groundSurface=Gravel, 3),
    } |> List.concat
