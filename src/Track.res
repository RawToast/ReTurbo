...
let demoTrack = {
  ...
  ->List.append(make(~times=8, ~incline=1.5, ~objects=list{makeSignLeft}, Left(mc1)))
  ->List.append(make(~times=8, ~incline=3.7, ~objects=list{makeSignLeft}, Left(mc2)))
  ->List.append(make(~times=8, ~incline=4.2, ~objects=list{makeSignRight}, Right(mc1)))
  ...
  ->List.append(make(~times=6, ~incline=0.2, Straight))
  ->List.append(make(~times=8, ~incline=0.8, Right(mc1)))
  ->List.append(make(~times=8, ~incline=2.2, ~objects=list{makeSignRight}, Right(hc1)))
  ...
  ->List.append(make(~times=4, ~incline=5.8, Left(ec1)))
  ->List.append(make(~times=8, ~incline=6.5, Left(mc1)))
  ...
  ->List.append(make(~times=3, ~incline=9.9, Left(mc1)))
  ->List.append(make(~times=4, ~incline=12.4, Left(hc2)))
  ->List.append(make(~times=4, ~incline=9.4, Left(mc2)))
  ->List.append(make(~times=4, ~incline=8.4, Left(ec1)))
  ...
  ->List.append(make(~times=8, ~incline=6.4, Right(hc1)))
  ->List.append(make(~times=8, ~incline=6.1, ~objects=list{makeSignRight}, Right(hc2)))
