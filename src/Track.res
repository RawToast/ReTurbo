...
let demoTrack = {
  ...
  ->List.append(make(~times=2, ~incline=-2., ~objects=bunchOfSmallTrees(1.35, 1.5, 1.65), Straight))
  ...
  ->List.append(
    make(~times=8, ~incline=4.2, ~objects=list{makePost(0.), makeSignRight}, Right(mc1)),
  )
  ...
  ->List.append(make(~times=8, Left(ec1)))
  ->List.append(
    make(~times=1, ~objects=list{makeStone(-0.85), makeStone(-0.65), makeStone(-0.45)}, Left(ec1)),
  )
  ->List.append(make(~times=1, ~objects=list{makeStone(-0.1)}, Left(ec1)))
  ...
  ->List.append(
    make(~times=8, ~incline=2.2, ~objects=list{makePost(0.), makeSignRight}, Right(hc1)),
  )
