...
let demoTrack = {
  ...
  ->List.append(make(~times=4, ~incline=-0.5, Straight))
  ->List.append(make(~times=8, Left(ec1)))
  ->List.append(make(~times=1, ~objects=list{makeStone(0.9), makeStone(0.6), makeStone(0.3)}, Left(ec1)))
  ->List.append(make(~times=1, ~objects=list{makeStone(0.1)}, Left(ec1)))
  ->List.append(make(~times=8, Left(ec1)))
  ->List.append(make(~times=1, ~objects=list{makeStone(-0.85), makeStone(-0.65), makeStone(-0.45)}, Left(ec1)))
  ->List.append(make(~times=1, ~objects=list{makeStone(-0.1), }, Left(ec1)))
  ->List.append(make(~times=4, Left(ec1)))
  ->List.append(make(~times=6, Straight))
  ->List.append(make(~times=6, Straight))
  ...
  ->List.append(makeCheckpoint(~incline=9.2, 6))
  ...
  ->List.append(make(~times=1, ~incline=4.5, ~objects=list{makeStone(-0.2)}, Straight))
  ->List.append(make(~times=1, ~incline=4.5, ~objects=list{makeStone(-0.4)}, Straight))
  ...
  ->List.append(make(~times=1, ~incline=1.2, ~objects=list{makeStone(-0.8)}, Straight))
  ->List.append(make(~times=1, ~incline=1.2, Straight))
  ->List.append(make(~times=1, ~incline=0.5, Straight))
  ->List.append(make(~times=1, ~incline=0., ~objects=list{makeStone(0.3), makeStone(0.6), makeStone(0.9)}, Straight))
  ->List.append(make(~times=1, ~incline=-0.5, Straight))
  ->List.append(makeCheckpoint(~incline=-1.3, 9))
  ->List.append(make(~times=1, ~incline=-1.2, Straight))
  ->List.append(make(~times=1, ~incline=-1.2, ~objects=list{makeStone(-0.2)}, Straight))
  ...
  ->List.append(makeCheckpoint(6))
  ->List.append(make(~times=4, Left(ec2)))
  ->List.append(make(~times=1, ~objects=list{makeStone(-0.9)}, Left(ec2)))
  ->List.append(make(~times=8, Left(ec2)))
  ->List.append(make(~times=1, ~incline=0.4, ~objects=list{makeStone(-0.8)}, Left(ec2)))
  ->List.append(make(~times=1, ~incline=-0.8, ~objects=list{makeStone(-0.85), makeStone(-0.65)}, Left(ec2)))
  ->List.append(make(~times=5, ~incline=0.3, Left(ec2)))
  ->List.append(make(~times=1, ~objects=list{makeStone(0.95)}, Left(ec2)))
  ->List.append(make(~times=4, Left(ec2)))
  ->List.append(make(~times=1, ~objects=list{makeStone(-0.75), makeStone(-0.5)}, Left(ec2)))
  ->List.append(make(~times=1, ~incline=-0.6, ~objects=list{makeStone(0.0), makeStone(-0.35)}, Left(ec2)))
  ->List.append(make(~times=5, ~incline=-1.2, Left(ec2)))
  ->List.append(make(~times=1, ~incline=-0.4, ~objects=list{makeStone(0.2), makeStone(0.35)}, Left(ec2)))
  ->List.append(make(~times=6, Left(ec2)))
  ->List.append(make(~times=1, ~objects=list{makeStone(0.8), makeStone(-0.35)}, Left(ec2)))
  ->List.append(make(~times=1, ~objects=list{makeStone(-0.8), makeStone(0.6), makeStone(0.9)}, Left(ec2)))
  ->List.append(make(~times=16, Left(ec2)))
  ->List.append(make(~times=4, Left(ec2)))
  ->List.append(make(~times=9, ~objects=list{makeSignRight}, Right(ec2)))
  ->List.append(make(~times=4, ~incline=1.1, Left(ec1)))
  ->List.append(make(~times=4, ~incline=0.5, Left(ec1)))
  ->List.append(makeCheckpoint(6))
}
